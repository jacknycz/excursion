...
function excursion_scripts() {
	...
	if ( is_singular() && wp_attachment_is_image() ) {
		wp_enqueue_script( 'excursion-keyboard-image-navigation', get_template_directory_uri() . '/js/keyboard-image-navigation.js', array( 'jquery' ), '20120202' );
	}
}
